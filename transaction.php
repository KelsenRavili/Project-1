    ...
    <section class="home">
        ...
        <div  class="container-transaction">
            ...
            <div class="note">
                    ...
                    <input type="text" class="styled-input" placeholder="Monthly Income" name="note">
            </div>
             <div class="category">
                <div>
            ...
            <div class="amount">
                    <label for="">Amount : <span style="font-size: 20px; color: orange;">Balance : $725</span></label>
                    <input type="text" class="styled-input" placeholder="$90" name = "amount">
            </div>
        </form>
        </div>
    </section>
